...
<head>
    ...
    <link href="css/danhmucsach.css" rel="stylesheet" type="text/css"/>
...
<main>
    ...
    <section>
        ...
        <div class="row">
            ...
            <div class="col-9">
                <h1 class="h11">Danh sách người mượn</h1>
                ...
                <table class="table table-bordered">
                    ...
                    while ($row = mysqli_fetch_array($result)){
                        ...
                        <tr>
                            ...
                            <td><?php echo $row['expira'] ?></td>
                            <td style="background:#009999;"> <a href="trasach.php?this_id=<?php echo $row['id']?>" onclick="return confirm('Đã trả sách')"style="color:white;text-decoration: none;">Trả sách</a></td>
                            <td style="background:#009999;"> <a href="editborrower.php?this_id=<?php echo $row['id']?>" style="color:white;text-decoration: none;">Sửa</a></td>
