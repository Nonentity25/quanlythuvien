                ...
                <table class="table table-bordered">
                    ...
                    while ($row = mysqli_fetch_array($result)){
                        ...
                        <tr>
                            ...
                            <td style="background:#009999;"> <a href="xoasach.php?this_id=<?php echo $row['id']?>" onclick="return confirm('Xóa Sách')"style="color:white;text-decoration: none;">Xóa</a></td>
                            <td style="background:#009999;"> <a href="editsach.php?this_id=<?php echo $row['id']?>" style="color:white;text-decoration: none;">Sửa</a></td>
